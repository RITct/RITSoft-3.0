...
class CommonAttendance{
    static function serialize_course($data, $faculty=null, $is_admin=null): array {
        $new_data = [];
    ...
    static function parse_attendance_input($inp){
    ...
    static function serialize_attendance_from_student($attendance, $student_admission_id, $faculty, $is_admin){
